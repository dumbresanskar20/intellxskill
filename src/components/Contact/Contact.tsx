...
import { MapPin, Phone, Mail, Globe, Clock, ChevronRight, Send, CheckCircle, ArrowLeft } from 'lucide-react'
...
export const Contact: React.FC<ContactProps> = ({ onSubmitSuccess, onSubmitError }) => {
  ...
  const inputClass = (hasError: boolean) =>
    `w-full px-4 py-3.5 rounded-xl border text-sm text-gray-900 placeholder:text-gray-400 bg-white transition-all duration-200 outline-none focus:ring-2 focus:ring-[#1E3A8A]/20 ${hasError
            ...
            <div className="bg-white rounded-3xl p-8 sm:p-10 shadow-sm border border-gray-100 relative overflow-hidden">
              ...
              {submitted && (
                <motion.div
                  ...
                  className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-white rounded-3xl p-8 text-center"
                >
                  ...
                  <motion.p
                    ...
                    className="text-gray-500 text-sm mb-2 max-w-xs"
                  >
                    Thank you for your interest! Our team will reach out to you within <strong className="text-gray-700">24 hours</strong> to schedule your free demo session.
                  </motion.p>
                  ...
                  <motion.button
                    ...
                    className="flex items-center gap-2 px-5 py-2.5 text-sm font-medium text-[#1E3A8A] bg-blue-50 hover:bg-blue-100 rounded-xl transition-colors"
                  >
