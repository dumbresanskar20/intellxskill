          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              <ScrollReveal key={card.title} delay={i * 0.08} direction="up">
                <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100 card-hover h-full">
            ...
            >
              {ABOUT_TABS.map((tab) => (
                <button
                  ...
                  className={`relative flex-1 flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl text-sm font-semibold transition-all duration-200 ${
                    activeTab === tab.id
                      ? 'text-[#1E3A8A]'
